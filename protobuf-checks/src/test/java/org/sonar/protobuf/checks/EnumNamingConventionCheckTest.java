...
public class EnumNamingConventionCheckTest {

  private EnumNamingConventionCheck check = new EnumNamingConventionCheck();
  private String fileName = "EnumNamingConventionCheck.proto";
