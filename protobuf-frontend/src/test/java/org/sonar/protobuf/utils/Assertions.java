 ...
 */
package org.sonar.protobuf.utils;
...
import org.sonar.protobuf.parser.ProtoBufGrammar;
import org.sonar.protobuf.parser.ProtoBufLexicalGrammar;
import org.sonar.protobuf.parser.ProtoBufNodeBuilder;
import org.sonar.protobuf.parser.TreeFactory;
...
public class Assertions {
  ...
  public static ParserAssert assertThat(GrammarRuleKey rule) {
    return assertThat(ProtoBufLexicalGrammar.createGrammarBuilder(), rule);
  }
  ...
  public static ParserAssert assertThat(LexerlessGrammarBuilder b, GrammarRuleKey rule) {
    return new ParserAssert(new ActionParser<Tree>(
      Charsets.UTF_8,
      b,
      ProtoBufGrammar.class,
      new TreeFactory(),
      new ProtoBufNodeBuilder(),
      rule));
  }
  ...
  public static class ParserAssert extends GenericAssert<ParserAssert, ActionParser<Tree>> {
    ...
    private void parseTillEof(String input) {
      ProtoBufTree tree = (ProtoBufTree) actual.parse(input);
    ...
    public ParserAssert matchesPrefix(String prefixToBeMatched, String remainingInput) {
      isNotNull();
      try {
        ProtoBufTree tree = (ProtoBufTree) actual.parse(prefixToBeMatched + remainingInput);
