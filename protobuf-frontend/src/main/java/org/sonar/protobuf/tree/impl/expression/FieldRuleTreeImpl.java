...
public class FieldRuleTreeImpl extends ProtoBufTree implements FieldRuleTree {

  private final InternalSyntaxToken token;

  public FieldRuleTreeImpl(InternalSyntaxToken token) {
    this.token = token;
  }

  @Override
  public Kind getKind() {
    return Kind.FIELD_RULE;
  }

  @Override
  public void accept(VisitorCheck visitor) {
    visitor.visitFieldRule(this);
  }
